  ...
  describe(PLUGIN_NAME .. ": [#" .. strategy .. "]", function()
    ...
    setup(function()
      ...
      blue_print.plugins:insert {
        ...
        config = {
          response_header_name = "X-NBACustomHeaderName",
        },
      }
    ...
    describe("The response", function()
      ...
      it("gets the expected header", function()
        ...
        local header_value = assert.response(r).has.header("X-NBACustomHeaderName")

        -- validate the value of that header
        assert.equal("http://httpbin.konghq.com/anything", header_value)
        -- assert.equal("shaquille oneal response", header_value)
